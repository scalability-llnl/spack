...
complete -c spack -n '__fish_spack_using_command_pos 0 ' -f -a read-only-core -d 'Update Spack to stop writing into its own prefix'
...
complete -c spack -n '__fish_spack_using_command ' -l install-scheme -r -f -a install_scheme
complete -c spack -n '__fish_spack_using_command ' -l install-scheme -r -d 'specify install scheme'
...
complete -c spack -n '__fish_spack_using_command bootstrap enable' -l scope -r -f -a '_builtin defaults system admin-customer site user install command_line'
...
complete -c spack -n '__fish_spack_using_command bootstrap disable' -l scope -r -f -a '_builtin defaults system admin-customer site user install command_line'
...
complete -c spack -n '__fish_spack_using_command bootstrap root' -l scope -r -f -a '_builtin defaults system admin-customer site user install command_line'
...
complete -c spack -n '__fish_spack_using_command bootstrap list' -l scope -r -f -a '_builtin defaults system admin-customer site user install command_line'
...
complete -c spack -n '__fish_spack_using_command bootstrap add' -l scope -r -f -a '_builtin defaults system admin-customer site user install command_line'
...
complete -c spack -n '__fish_spack_using_command buildcache check' -l scope -r -f -a '_builtin defaults system admin-customer site user install command_line'
...
complete -c spack -n '__fish_spack_using_command compiler find' -l scope -r -f -a '_builtin defaults system admin-customer site user install command_line'
...
complete -c spack -n '__fish_spack_using_command compiler add' -l scope -r -f -a '_builtin defaults system admin-customer site user install command_line'
...
complete -c spack -n '__fish_spack_using_command compiler remove' -l scope -r -f -a '_builtin defaults system admin-customer site user install command_line'
...
complete -c spack -n '__fish_spack_using_command compiler rm' -l scope -r -f -a '_builtin defaults system admin-customer site user install command_line'
...
complete -c spack -n '__fish_spack_using_command compiler list' -l scope -r -f -a '_builtin defaults system admin-customer site user install command_line'
...
complete -c spack -n '__fish_spack_using_command compiler info' -l scope -r -f -a '_builtin defaults system admin-customer site user install command_line'
...
complete -c spack -n '__fish_spack_using_command compilers' -l scope -r -f -a '_builtin defaults system admin-customer site user install command_line'
...
complete -c spack -n '__fish_spack_using_command config' -l scope -r -f -a '_builtin defaults system admin-customer site user install command_line'
...
complete -c spack -n '__fish_spack_using_command external find' -l scope -r -f -a '_builtin defaults system admin-customer site user install command_line'
...
complete -c spack -n '__fish_spack_using_command mirror add' -l scope -r -f -a '_builtin defaults system admin-customer site user install command_line'
...
complete -c spack -n '__fish_spack_using_command mirror remove' -l scope -r -f -a '_builtin defaults system admin-customer site user install command_line'
...
complete -c spack -n '__fish_spack_using_command mirror rm' -l scope -r -f -a '_builtin defaults system admin-customer site user install command_line'
...
complete -c spack -n '__fish_spack_using_command mirror set-url' -l scope -r -f -a '_builtin defaults system admin-customer site user install command_line'
...
complete -c spack -n '__fish_spack_using_command mirror set' -l scope -r -f -a '_builtin defaults system admin-customer site user install command_line'
...
complete -c spack -n '__fish_spack_using_command mirror list' -l scope -r -f -a '_builtin defaults system admin-customer site user install command_line'
...
# spack read-only-core
set -g __fish_spack_optspecs_spack_read_only_core h/help
complete -c spack -n '__fish_spack_using_command read-only-core' -s h -l help -f -a help
complete -c spack -n '__fish_spack_using_command read-only-core' -s h -l help -d 'show this help message and exit'
...
complete -c spack -n '__fish_spack_using_command repo list' -l scope -r -f -a '_builtin defaults system admin-customer site user install command_line'
...
complete -c spack -n '__fish_spack_using_command repo add' -l scope -r -f -a '_builtin defaults system admin-customer site user install command_line'
...
complete -c spack -n '__fish_spack_using_command repo remove' -l scope -r -f -a '_builtin defaults system admin-customer site user install command_line'
...
complete -c spack -n '__fish_spack_using_command repo rm' -l scope -r -f -a '_builtin defaults system admin-customer site user install command_line'
