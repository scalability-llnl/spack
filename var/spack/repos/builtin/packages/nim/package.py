...
class Nim(Package):
    ...
    variant("sqlite", default=True, when="@:2.0", description="Install SQLite for std/db_sqlite")
    ...
    depends_on("openssl@:3", type="run", when="@:1.6.10")
    ...
    patch("nimble_https_fallback.patch", when="@:1.2.10,1.4.0:1.4.4")  # CVE-2021-21373
    patch("nimble_quote_doCmd.patch", when="@:1.2.10,1.4.0:1.4.4")  # CVE-2021-21372
