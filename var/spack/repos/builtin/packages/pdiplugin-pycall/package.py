...
class PdipluginPycall(CMakePackage):
    ...
    depends_on("pdi+python@1.6.0", type=("link", "run"), when="@1.6.0")
    depends_on("pdi+python@1.5.5", type=("link", "run"), when="@1.5.5")
    depends_on("pdi+python@1.5.4", type=("link", "run"), when="@1.5.4")
    depends_on("pdi+python@1.5.3", type=("link", "run"), when="@1.5.3")
    depends_on("pdi+python@1.5.2", type=("link", "run"), when="@1.5.2")
    depends_on("pdi+python@1.5.1", type=("link", "run"), when="@1.5.1")
    depends_on("pdi+python@1.5.0", type=("link", "run"), when="@1.5.0")
    depends_on("pdi+python@1.4.3", type=("link", "run"), when="@1.4.3")
    depends_on("pdi+python@1.4.2", type=("link", "run"), when="@1.4.2")
    depends_on("pdi+python@1.4.1", type=("link", "run"), when="@1.4.1")
    depends_on("pdi+python@1.4.0", type=("link", "run"), when="@1.4.0")
    depends_on("pdi+python@1.3.1", type=("link", "run"), when="@1.3.1")
    depends_on("pdi+python@1.3.0", type=("link", "run"), when="@1.3.0")
    depends_on("pdi+python@1.2.2", type=("link", "run"), when="@1.2.2")
