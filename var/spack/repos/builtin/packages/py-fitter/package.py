...
class PyFitter(PythonPackage):
    ...
    depends_on("py-click@8.1.6:9", type=("build", "run"))
    depends_on("py-joblib@1.3.1:2", type=("build", "run"))
    depends_on("py-matplotlib@3.7.2:4", type=("build", "run"))
    depends_on("py-numpy@1.20.0:2", type=("build", "run"))
    depends_on("py-pandas@0.23.4:3", type=("build", "run"))
    depends_on("py-scipy@0.18:2", type=("build", "run"))
    depends_on("py-tqdm@4.65.1:5", type=("build", "run"))
