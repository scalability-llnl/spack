...
class PyGurobipy(PythonPackage):
    ...
    if arch == "x86_64":
        version(
            "12.0.0-py3.12",
            sha256=(
                "90bba495efb25cff5a3826158aff7be29637d2e80accc3a89a98cb8630856106"
            ),
            expand=False,
        )
        version(
        ...
        version(
            "12.0.0-py3.10",
            sha256=(
                "71ea7c653a92377991291a7e81b456fdfd06f8e3fc36b74a54444c2bab5225a8"
            ),
            expand=False,
            )
        version(
            "12.0.0-py3.9",
            sha256=(
                "5e0b0ea5ce2eaf4bd940821860fe37dcc8fd3fe7215ab0d97cceaedfa5eeb15d"
            ),
            expand=False,
            )
    elif arch == "aarch64":
        version(
            "12.0.0-py3.12",
            sha256=(
                "f8287de7535c3b9c97f4aa8716969d70302a972bd09e9d3b6fbd7266ca0eab72"
            ),
            expand=False,
        )
        version(
        ...
        version(
            "12.0.0-py3.10",
            sha256=(
                "d4803e659fefc2102e9dc3d84f3d7f54a3918127c362cbebae6103b7e13849c6"
            ),
            expand=False,
            )
        version(
            "12.0.0-py3.9",
            sha256=(
                "68c0ffe4ac8c4d87662307f96f50f40ddc3867d71c6ebabce4bda52f4688ecbd"
            ),
            expand=False,
            )
    else:
