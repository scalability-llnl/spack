...
class PySchemaSalad(PythonPackage):
    ...
    pypi = "schema-salad/schema_salad-8.5.20240503091721.tar.gz"
    ...
    depends_on("py-setuptools-scm@8.0.4:8+toml", type="build", when="@8.4.20231024070348:")
    ...
    depends_on("py-types-pkg-resources", type="build", when="@:8.4.20231117150958")
    ...
    def url_for_version(self, version):
        ...
        if version >= Version("8.5.20240410123758"):
            letter = "schema_salad"
        else:
            letter = "schema-salad"
